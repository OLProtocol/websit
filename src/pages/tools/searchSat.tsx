...
import { useToast, Card, CardHeader, CardBody, Input, InputGroup, InputRightAddon, Tooltip, Flex, ButtonGroup, IconButton, Button, Spacer, Image, Heading, Box, FormControl, InputLeftAddon } from '@chakra-ui/react';
            ...
            <Card>
                <CardBody pt={0}>
                    <FormControl>
                        ...
                        <Flex gap={4} pt={2}>
                            <Spacer />
                            <Button colorScheme='teal' size='md' onKeyDown={handleKeyDown} isLoading={loading} onClick={doSearch}>
                                Search
                            </Button>
                        </Flex>
                    </FormControl>
